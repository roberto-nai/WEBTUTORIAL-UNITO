$(document).ready(function(){
    ...
    function renderTableEvents(data){
        ...
        table.append("<thead><tr><th>Event ID (db)</th><th>Session ID</th><th>Language</th><th>Page file</th><th>Page order</th><th>Paragraph</th><th>Event</th><th>Duration</th><th>Timestamp</th></thead>");
		table.append("<tbody>");
		var tr;
    ...
    function renderTableQuiz(data)
    {
        ...
        var count = 0; // numero di righe estratte (visualizzate)
		var table = $("<table id=\"tblData\" class=\"display\" style=\"width:100%\">");
	    table.append("<thead><tr><th>Event ID (db)</th><th>Session ID</th><th>Language</th><th>Page file</th><th>Page order</th><th>Answer</th><th>Correct?</th><th>Timestamp</th></thead>");
		table.append("<tbody>");
		var tr;
        $.each(data, function(i, row)
			{
