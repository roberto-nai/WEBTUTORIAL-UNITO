...
<html lang="en">
  ...
  <div class="container" id='quiz-02'>
    <p>A model defines the behavior of the agents in the environment also through the use of opportune _________ that they can assume various values during the simulation:</p>
  <?php
