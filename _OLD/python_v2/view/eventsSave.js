$(document).ready(function(){
    ...
    function savePage(projectID, sessionID, pageName, pageOrder, pagePara, event, duration, lang)
    {
    ...
    // 1) save page
    savePage(projectID, sessionID, pageName, pageOrder, pagePara, event, duration, lang);
