$(document).ready(function(){
    ...
    function quizCheck(pageLevel, answer, quiz_mandatory)
    {
        var params = {'action':'quiz_check', 'page_level':pageLevel, 'answer':answer, 'quiz_mandatory': quiz_mandatory};
        // console.log("Params: \n"); // debug
        // console.log(params); // debug
        $.post('./controller/eventsSave.php', params, function(data)
        {
    ...
    $("#btnSubmit").click(function(){
        ...
        if(radioValue){
            ...
            quizCheck(pageLevel, parseInt(radioValue), quiz_mandatory);
        }
        else{
            quizFeedback(3);
        }
    ...
    $("#btnNext").click(function(){
        ...
        pageSave(projectID, sessionID, pageName, pageOrder, pagePara, event, duration, lang);
        quizCheck(pageLevel, 0, quiz_mandatory); // check the quiz with answer 0 (in case of not mandatory quiz)
    });
