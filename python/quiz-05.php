...
<html lang="<?php echo $lang;?>">
  ...
  <div class="container" id='quiz-01'>
    <h2 class="text-primary">Conversione dei dati</h2>
      <div class="panel panel-default">
        <div class="panel-body">
          <p>
           Il seguente codice é incompleto:<br />
           
          <code>
          nval = 451 <br />
          _________ <br />
          print( "Fahreneit " + nstr)
  ...
  <div class="container" id='quiz-02'>
    <p>Quale riga occorre aggiungere per far funzionare correttamente il codice?</p>
  <?php
