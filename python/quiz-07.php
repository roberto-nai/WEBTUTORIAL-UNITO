...
<html lang="<?php echo $lang;?>">
  ...
  <div class="container" id='quiz-01'>
    <h2 class="text-primary">Ciclo FOR</h2>
      <div class="panel panel-default">
        <div class="panel-body">
          <p>Una variabile <i>tot</i> è inizializzata a 0 <br /> e all'interno del seguente ciclo <code>for</code> alcune istruzioni ne incrementano il valore: <br />
          <code>
          tot = 0 <br />
          for n in range(0,10):<br />
          &nbsp;tot = tot + 10<br />
          &nbsp;print("ciao")<br />
          &nbsp;tot = tot + 10
          </code>
  ...
  <div class="container" id='quiz-02'>
    <p>Quale sarà il valore finale di <i>tot</i> al termine del ciclo?</p>
  <?php
