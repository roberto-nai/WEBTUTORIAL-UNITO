...
<meta charset="utf-8">
  ...
  <script type="text/javascript">
      ...
      console.log("Page title: "+ pageTitle.toString());
      var pageMenu = "<?php echo $menu_name;?>";
      console.log("Menu: "+ pageMenu.toString());
      var pageLevelReached = "<?php echo $_SESSION['page_level_reached'];?>";
      console.log("Page level reached (session): "+ pageLevelReached.toString());
      var pageNext = "<?php echo $page_next;?>";
      console.log("Page next level: "+ pageNext.toString());
      ...
      var google_form = "<?php echo $google_form;?>";
      console.log("Google form: "+ google_form.toString());
      var google_form_target = "<?php echo $google_form_target;?>";
      console.log("Google form target: "+ google_form_target.toString());
  </script>
</head>